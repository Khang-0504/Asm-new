    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <title>Quản lý Newsletter - ASM News Admin</title>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <div class="text-center py-5">
                                                            ...
                                                            <h5 class="text-muted">Chưa có đăng ký Newsletter nào</h5>
                                                            <p class="text-muted">Người dùng có thể đăng ký Newsletter
                                                                từ trang chủ</p>
                                                        </div>
                                                    </c:otherwise>
                                                </c:choose>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Bạn có chắc chắn muốn xóa email "<span id="deleteEmail"></span>" khỏi danh sách
                                    Newsletter?</p>
